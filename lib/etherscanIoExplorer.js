...
class etherscanIoExplorer{
  ...
  constructor (network, apikey) {
    this.api = axios.create({
      baseURL: config.etherscanIoURL[network]
    });
  ...
  async getAccountBalance(address){
    try {
      var response = await this.api.get("module=account&action=balance&address="+ address + "&tag=latest&apikey="+ this.apikey)
    } catch (e) {
  ...
  async getAccountMutipleBalance(addresses){
    try {
      var response = await this.api.get("module=account&action=balancemulti&address="+ addresses +"&tag=latest&apikey="+ this.apikey)
    } catch (e) {
  ...
  async getAccountTxlist(address, start=0, end=999999, sort='asc', page=1, offset=10){
    try {
      var response = await this.api.get("module=account&action=txlist&address="+address +"&startblock="+ start +"&endblock="+ end +"&page="+page+"&offset="+offset+"&sort="+ sort +"&apikey="+this.apikey)
    } catch (e) {
  ...
  async getTxlistInternal(address,start=0, end=999999, page=1, offset=10, sort='asc'){
    try {
      var response = await this.api.get("module=account&action=txlistinternal&address="+address+"&startblock="+start+"&endblock="+end+"&page="+page+"&offset="+offset+"&sort="+sort+"&apikey=YourApiKeyToken"+ this.apikey)
    } catch (e) {
  ...
  async getTxlistInternalByHash(hash){
    try{
      var response = await this.api.get("module=account&action=txlistinternal&txhash="+hash+"&apikey="+this.apikey)
    }catch(e){
  ...
  async getTokenTx(contract, page=1,offset=100, sort='asc'){
    try{
      var response = await this.api.get('module=account&action=tokentx&contractaddress='+contract+'&page='+page+'&offset='+offset+'&sort='+sort+'&apikey='+this.apikey)
    }catch(e){
  ...
  async getTokenTxByAddress(contract, address, page=1, offset=100, sort='asc'){
    try {
      var response = await this.api.get("module=account&action=tokentx&contractaddress="+contract+"&address="+address+"&page="+page+"&offset="+offset+"&sort="+sorc+"&apikey="+this.apikey)
    } catch (e) {
  ...
  async getMinedBlocks(address, page=0, offset=100){
    ...
    try {
      var response = await this.api.get("module=account&action=getminedblocks&address="+address+"&page="+page+"&offset="+offset+"&blocktype=blocks&apikey="+this.apikey)
    } catch (e) {
  ...
  async getStatus(hash){
    try {
      var response = await this.api.get("module=transaction&action=getstatus&txhash="+ hash +"&apikey="+this.apikey)
    } catch(e) {
  ...
  async getTxReceiptStatus(hash){
    try {
      var response = await this.api.get("module=transaction&action=gettxreceiptstatus&txhash="+hash+"&apikey="+this.apikey)
    } catch (e) {
  ...
  async getBlockReward(height){
    try {
      var response = await this.api.get('module=block&action=getblockreward&blockno='+height+'&apikey='+this.apikey)
    } catch (e) {
      throw notice.createErrorString('getUnTx', e)
    }
    return response.data;
  ...
  async getLogs(fromBlock, toBlock, address, topic0){
    try {
      var response = await this.api.get("module=logs&action=getLogs&fromBlock="+fromBlock+"&toBlock="+toBlock+"&address="+address+"&topic0="+topic0+"&apikey="+this.apikey)
    } catch (e) {
      throw notice.createErrorString('getUnTxInfo', e)
    }
    return response.data;
  ...
  async getSupply(){
    try{
      var response = await this.api.get("module=stats&action=ethsupply&apikey="+this.apikey)
    }catch (e) {
      throw notice.createErrorString("getStat", e)
    }
  }
  /**
  ...
  async getEthPrice(){
    try{
      var response = await this.api.get("module=stats&action=ethprice&apikey="+this.apikey)
    }catch (e) {
      throw notice.createErrorString("getStat", e)
    }
  }
   ...
   * @returns {Promise.<void>}
   */
  async getEthPrice(begin, end, sort){
    try{
      var response = await this.api.get("module=stats&action=chainsize&startdate="+begin+"&enddate="+end+"&clienttype=geth&syncmode=default&sort="+sort+"&apikey="+this.apikey)
    }catch (e) {
      throw notice.createErrorString("getStat", e)
    }
  }
