...
class etherscanIoExplorer{
  ...
  async getTokenTxByAddress(contract, address, page=1, offset=100, sort='asc'){
    try {
      var response = await this.api.get("/api?module=account&action=tokentx&contractaddress="+contract+"&address="+address+"&page="+page+"&offset="+offset+"&sort="+sorc+"&apikey="+this.apikey)
    } catch (e) {
