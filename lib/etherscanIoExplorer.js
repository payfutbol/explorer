...
class etherscanIoExplorer{
  ...
  async getTokenBalance(address, tokenname, contract){
    try{
      var response = await this.api.gete("/api?module=account&action=tokenbalance&address="+address+"&tokenname="+tokenname+"&contractaddress="+contract+"&tag=latest&apikey"+ this.apikey)
    }catch(e){
