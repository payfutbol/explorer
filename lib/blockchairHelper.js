      ...
      json = {
        Cmdlist: {
          btc_chain: {
            ...
            method:  ["getStats","getBlockRelated",'getBlocksRelated','getRawBlock','getRawBlocks','getBlocksFroSql','getTransaction','getTransactions','getRawTransaction','postPushTransaction','getTransactionForSql','getMempoolTransactions','getAddress','getAddresses','getXput','getAddressForSql','getOutputs','getMempoolOutputs','getUncle','getUncles','getBlockChangeState','getMempoolState','getMempoolState','getNodes']
          },
          eth_chain: {
            symbol: ['eth', 'erc20'],
            method: ['getStats','getBlockRelated','getBlocksRelated','getRawBlock','getRawBlocks','getBlocksFroSql','getTransaction','getTransactions','getRawTransaction','postPushTransaction','getTransactionForSql','getMempoolTransactions','getAddress','getEthUncles','getCalls','getMempoolState','getNodes']
          },
          erc20_chain: {
            symbol: ["erc20"],
